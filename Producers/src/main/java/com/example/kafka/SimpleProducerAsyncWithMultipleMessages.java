...
public class SimpleProducerAsyncWithMultipleMessages {
//    public static final Logger  logger = LoggerFactory.getLogger(SimpleProducerAsync.class.getName());
    ...
    public static void main(String[] args) {
        ...
        for (int seq = 0; seq < 20; seq++) {
            ProducerRecord<String, String> record = new ProducerRecord<String, String>(topic, String.valueOf(seq), "this-is-" + seq);
