...
public class SimpleConsumerMultipleTopicRebalance {
    ...
    public static void main(String[] args) {
        ...
        props.setProperty(ConsumerConfig.GROUP_ID_CONFIG, "group-multiple-topic");
        ...
        try {
            while (true) {
                ...
                for (ConsumerRecord record: records) {
                    logger.info("topic: {} record_key:{}, record_value:{}, partition:{}, record's offset:{}",
